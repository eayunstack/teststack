...
--publicurl=http://$CONTROLL_NAME:8004/v1/%\(tenant_id\)s \
--internalurl=http://$CONTROLL_NAME:8004/v1/%\(tenant_id\)s \
--adminurl=http://$CONTROLL_NAME:8004/v1/%\(tenant_id\)s
keystone service-create --name=heat-cfn --type=cloudformation \
--description="Orchestration CloudFormation"
keystone endpoint-create \
--service-id=$(keystone service-list | awk '/ cloudformation / {print $2}') \
--publicurl=http://$CONTROLL_NAME:8000/v1 \
--internalurl=http://$CONTROLL_NAME:8000/v1 \
--adminurl=http://$CONTROLL_NAME:8000/v1
